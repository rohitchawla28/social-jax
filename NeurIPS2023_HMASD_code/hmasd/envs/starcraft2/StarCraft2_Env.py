...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        """
        # Map arguments
        self.state_agent_specific = args.state_agent_specific
        ...
        for i in range(self.n_agents):
            ...
            if self.state_agent_specific:
                self.share_observation_space.append(self.get_state_size())
            else:
                self.share_observation_space.append([self.get_state_size_without_as()])
    ...
    def get_state_without_as(self):
        """Returns the global state without agent specific.
    ...
    def get_state_size_without_as(self):
