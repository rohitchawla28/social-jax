...
def get_config():
    ...
    Prepare parameters:
        --algorithm_name <algorithm_name>
            specifiy the algorithm, including `["hmasd"]`
        --experiment_name <str>
    ...
    # add for skill learning
    parser.add_argument("--intri_rew_exp", type=int, default=1)
    parser.add_argument("--skill_last_layer", type=int, default=0)
    parser.add_argument("--skill_interval", type=int, default=5)
    parser.add_argument("--skill_type", type=str, default="Discrete", choices=["Discrete", "Continuous"])
    ...
    parser.add_argument("--lambda_env", type=float, default=1)
    parser.add_argument("--lambda_team", type=float, default=1)
    parser.add_argument("--lambda_indi", type=float, default=1)
